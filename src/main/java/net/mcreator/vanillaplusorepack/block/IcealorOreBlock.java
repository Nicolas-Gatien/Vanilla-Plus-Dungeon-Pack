...
import net.mcreator.vanillaplusorepack.item.IcealorItem;
...
public class IcealorOreBlock extends VanillaPlusOrePackModElements.ModElement {
	@ObjectHolder("vanilla_plus_ore_pack:icealor_ore")
	public static final Block block = null;
	public IcealorOreBlock(VanillaPlusOrePackModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(IcealorItem.block, (int) (2)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("icealor_ore", "icealor_ore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 4)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(5, 0, 0, 64))));
		}
	}
}
